...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_CAPSLOCK,    LGUI_T(KC_A),   LALT_T(KC_R),   LCTL_T(KC_S),   LSFT_T(KC_T),   KC_G,           KC_AUDIO_VOL_DOWN,                                                                KC_MEDIA_PREV_TRACK,KC_M,           LSFT_T(KC_N),   LCTL_T(KC_E),   LALT_T(KC_I),   LGUI_T(KC_O),   KC_ENTER,
    KC_LSHIFT,      KC_Z,           RALT_T(KC_X),   KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       RALT_T(KC_DOT), KC_SLASH,       KC_RSHIFT,
    KC_LCTRL,       KC_LALT,        KC_LGUI,        LT(3,KC_ESCAPE),LT(6,KC_BSPACE),LT(9,KC_ESCAPE),                                                                                                LT(9,KC_ESCAPE),LT(5,KC_DELETE),KC_RALT,        KC_LEFT,        KC_RIGHT,       LT(7,KC_PSCREEN),
  ...
  [1] = LAYOUT_moonlander(
    ...
    KC_CAPSLOCK,    LGUI_T(KC_R),   LALT_T(KC_S),   LCTL_T(KC_N),   LSFT_T(KC_T),   KC_P,           KC_AUDIO_VOL_DOWN,                                                                KC_MEDIA_PREV_TRACK,KC_Y,           LSFT_T(KC_U),   LCTL_T(KC_E),   LALT_T(KC_A),   LGUI_T(KC_I),   KC_ENTER,
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_CAPSLOCK,    LGUI_T(KC_A),   LALT_T(KC_S),   LCTL_T(KC_D),   LSFT_T(KC_F),   KC_G,           KC_AUDIO_VOL_DOWN,                                                                KC_MEDIA_PREV_TRACK,KC_H,           LSFT_T(KC_J),   LCTL_T(KC_K),   LALT_T(KC_L),   LGUI_T(KC_SCOLON),KC_ENTER,
  ...
  [3] = LAYOUT_moonlander(
    ...
    LCTL(KC_F),     LCTL(KC_X),     KC_HOME,        KC_UP,          KC_END,         KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,
    LCTL(KC_A),     LCTL(KC_C),     KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      KC_NO,                                                                          KC_NO,          KC_NO,          KC_LSHIFT,      KC_LGUI,        KC_LALT,        KC_LCTRL,       KC_TRANSPARENT,
    LCTL(KC_Z),     LCTL(KC_V),     KC_NO,          KC_SPACE,       KC_ENTER,       KC_BSPACE,                                      KC_NO,          KC_NO,          KC_NO,          KC_RALT,        KC_NO,          KC_TRANSPARENT,
