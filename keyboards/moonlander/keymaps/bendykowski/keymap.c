...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_LCTRL,       KC_LALT,        KC_LGUI,        LT(3,KC_BSPACE),LT(6,KC_ESCAPE),LT(9,KC_ESCAPE),                                                                                                LT(9,KC_ESCAPE),LT(5,KC_DELETE),KC_RALT,        KC_LEFT,        KC_RIGHT,       LT(7,KC_PSCREEN),
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, LCTL(KC_X),     KC_HOME,        KC_UP,          KC_END,         KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,
    KC_TRANSPARENT, LCTL(KC_C),     KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      KC_NO,                                                                          KC_NO,          KC_NO,          KC_LSHIFT,      KC_LGUI,        KC_LALT,        KC_LCTRL,       KC_TRANSPARENT,
    KC_TRANSPARENT, LCTL(KC_V),     KC_NO,          KC_SPACE,       KC_ENTER,       KC_BSPACE,                                      KC_NO,          KC_NO,          KC_NO,          KC_RALT,        KC_NO,          KC_TRANSPARENT,
